...
void ABasePlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	InputComponent->BindAxis("LookAround", this, &ABasePlayer::SetCameraRotation);
...
void ABasePlayer::SetCameraRotation(float Value)
{
	FRotator rotator = FRotator(0, 1, 0) * RotationForce * Value;
